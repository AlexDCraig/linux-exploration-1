...
// Given two strings ciphertext and encryptionkey, return a c string
// that corresponds to their concatenation
// Separate the two strings with a newline to distinguish whether 
// the function that reads the whole string is seeing ciphertext or
// the encryptionkey
...
int main(int argc, char *argv[])
{
	...
	// otp decryption has not received the correct message back for verifying
	...
	// print the resulting plaintext to stdout
	printf("%s\n", plaintext);
