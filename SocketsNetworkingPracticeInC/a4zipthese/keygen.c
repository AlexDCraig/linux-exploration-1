...
// generate and return a c string consisting of a key's input alphabet
char* generateAlphabet()
{
...
// randomly choose an index and return that element
// used to generate a c string of random symbols
...
// get a cstring that corresponds to a keygen for use with enc/dec
// end the c string of random chars with a newline
